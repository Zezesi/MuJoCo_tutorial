...
class panda_env:
    ...
    def step(self,action):
        ...
        gripper_id = self.data.site("gripper").id
        gripper_xvel = np.zeros(6)  # [angular, linear]
...
if __name__ == "__main__":
    ...
    train_env = panda_env(action_space_size=8,state_space_size=25,num_of_attack_points=1)
